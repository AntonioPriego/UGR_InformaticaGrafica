...
class Malla3D
{
	...
	void setColorPuntos          (Tupla3f color=Tupla3f(0,0,0));
	void setColorSecundarioPuntos(Tupla3f color=Tupla3f(1,1,1));
	...
	std::vector<Tupla3f> c2;   // una terna de 3 enteros por cada color de vertice secundario
