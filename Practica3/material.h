...
class Material {
 ...
 public:
	Material (Tupla4f _emision  = Tupla4f(0.0,0.0,0.0,1),
              Tupla4f _difuso   = Tupla4f(0.0,0.0,0.0,1),
              Tupla4f _especular= Tupla4f(0  ,0  ,0  ,1),
              Tupla4f _ambiente = Tupla4f(0.3,0.3,0.3,1),
              float   _brillo   = 0.5 );
	void aplicar();
